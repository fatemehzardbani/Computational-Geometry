...
#else
long timespec_diff(long strt, long stp) {
	return stp - strt;
}
long ptim, ctim;
#endif
...
#ifndef __unix__
		ctim = clock();
		out << " input time: " << timespec_diff(ptim, ctim) << " milliseconds\n";
		cout << " input time: " << timespec_diff(ptim, ctim) << " milliseconds\n";
#endif
...
#else
		ctim = clock();
		out << " running time: " << timespec_diff(ptim, ctim) << " milliseconds\n";
		cout << " running time: " << timespec_diff(ptim, ctim) << " milliseconds\n";
#endif
		int sz = ans.size();
		out << sz << "\n";
		cout << n << " " << sz << "\n";
